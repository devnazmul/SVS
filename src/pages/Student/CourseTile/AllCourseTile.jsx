...
import FilterEmploymentStatus from "./FilterCourseTitle";
import CreateEmploymentStatus from "./CreateCourseTitle";
import UpdateEmploymentStatus from "./UpdateCourseTitle";
...
import {
  deleteCourseTitle,
  getAllCourseTitle,
  toggleCourseTitleActiveDeactive,
} from "../../../apis/courseTitle/courseTitle";
import CreateCourseTitle from "./CreateCourseTitle";
import UpdateCourseTitle from "./UpdateCourseTitle";

export default function AllCourseTile() {
  ...
  const toggleFunc = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        toggleCourseTitleActiveDeactive(id)
          .then((res) => {
            setIsUpdated(Math.random());
            Swal.fire({
              title: "Done!",
        ...
        <div className="relative h-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center relative gap-5">
            <div className="flex flex-col gap-2 w-full text-center md:text-left">
              <Headings level={1}>All Course Titles</Headings>
              <h3>
                Total {data?.total}{" "}
                {data?.total > 1 ? "Course Titles" : "Course Title"} Found
              </h3>
            </div>
            ...
            <div className="flex flex-col justify-end md:flex-row gap-5 w-full">
              ...
              <div className="flex justify-end md:justify-start gap-5">
                {checkPermissions(
                  [COURSE_TITLE_CREATE, STUDENT_CREATE],
                  permissions
                ) && (
                  <button
