...
import {
  getSingleCourseTitle,
  updateSingleCourseTitle,
} from "../../../apis/courseTitle/courseTitle";

export default function UpdateCourseTitle({ handleClosePopup, id }) {
  ...
  const updateFunction = () => {
    ...
    updateSingleCourseTitle(formData)
      .then((res) => {
