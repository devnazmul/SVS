...
import {
  ...
  toggleEmployeeStatusActiveDeactive,
} from "../../../apis/employeeStatus/employeeStatus";
import FilterEmploymentStatus from "./FilterStudentStatus";
import CreateEmploymentStatus from "./CreateStudentStatus";
import UpdateEmploymentStatus from "./UpdateStudentStatus";
...
import {
  deleteStudentStatus,
  getAllStudentStatus,
  toggleStudentStatusActiveDeactive,
} from "../../../apis/studentStatus/studentStatus";
import { checkPermissions } from "../../../utils/checkPermissions";

export default function AllStudentStatus() {
  ...
  const toggleFunc = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        toggleStudentStatusActiveDeactive(id)
          .then((res) => {
            setIsUpdated(Math.random());
            Swal.fire({
              title: "Done!",
      ...
      if (result.isConfirmed) {
        ...
        deleteStudentStatus(id)
          .then((res) => {
            ...
            Swal.fire({
              title: "Deleted!",
              text: "Student status has been deleted.",
              icon: "success",
            });
  ...
  const [actions, setActions] = useState([
    ...
    },
    {
      ...
      permissions: [STUDENT_STATUS_DELETE],
      disabledOn: [],
    },
  ]);
  ...
  const [cols, setCols] = useState([
    ...
    { name: "Preview", attribute_name: "preview", minWidth: 20, show: true },
  ...
  return (
    <CheckPermission
      permissionArray={[STUDENT_STATUS_CREATE, STUDENT_STATUS_VIEW]}
    >
        ...
        <div className="relative h-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center relative gap-5">
            <div className="flex flex-col gap-2 w-full text-center md:text-left">
              <Headings level={1}>All Student Status</Headings>
              <h3>
                Total {data?.total}{" "}
                {data?.total > 1 ? "Student statuses" : "Student status"} Found
              </h3>
            </div>
            ...
            <div className="flex flex-col justify-end md:flex-row gap-5 w-full">
              ...
              <div className="flex justify-end md:justify-start gap-5">
                {checkPermissions([STUDENT_STATUS_CREATE], permissions) && (
                  <button
