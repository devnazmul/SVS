...
export default function CreateEmployee() {
  ...
  const getAllDepartmentsData = () => {
    ...
    getAllDepartmentsWithoutPerPage()
      .then((res) => {
        setDepartments(res.map((dep) => ({ id: dep?.id, label: dep?.name })));
  ...
  return (
    <div>
      <div className="border-b-2 border-primary-content py-6">
        <Headings level={1}>Add Employee</Headings>
      </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-5">
          <div className="w-full md:w-1/2">
            ...
            <CustomAutoComplete
              ...
              formData={formData}
              setFormData={setFormData}
              defaultValue={errors?.address_line_1}
            />
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-5">
          ...
          <CustomNumberFieldWithCurrency
            currency="£"
            defaultValue={formData?.salary_per_annum}
            disable={false}
            error={errors?.salary_per_annum}
            fieldClassName={"w-full"}
            id={"salary_per_annum"}
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-5">
          ...
          <CustomMultiSelect
            ...
            options={roles}
            error={errors?.role}
            onSelect={(e) => setFormData({ ...formData, role: e[0]?.value })}
          />
        </div>
        {/* DEPARTMENT  */}
        <div className="flex flex-col md:flex-row justify-between items-end w-full gap-5">
          <CustomMultiSelect
      ...
      {/* EMERGENCY CONTACT 1  */}
      <div className="flex flex-col gap-5">
        <Headings level={1} className={`mb-5`}>
          Emergency Contact 1{" "}
          <span className="text-error text-sm">(This section is required)</span>{" "}
        </Headings>
      ...
      <div className="collapse collapse-plus bg-base-300 shadow-md">
        ...
        <div className="collapse-content">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-5">
              <CustomField
                defaultValue={emergencyContactTwo?.relationship_of_above_to_you}
                disable={false}
                error={emergencyContactTwoErrors?.relationship_of_above_to_you}
                fieldClassName={"w-full"}
                id={"relationship_of_above_to_you"}
                label={"Relationship Of Above To You"}
                name={"relationship_of_above_to_you"}
              ...
              <div className="w-full md:w-1/2">
                {/* LABEL */}
                <label htmlFor="address_line_1" className="label">
                  <span className="label-text text-md font-bold">Address</span>
                </label>
