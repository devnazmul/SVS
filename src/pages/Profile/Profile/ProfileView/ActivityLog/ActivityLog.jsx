...
import { USER_DELETE, USER_UPDATE } from "../../../../../constant/permissions";
        ...
        <div className="pt-5 relative">
          ...
          <Table
            ...
            rows={data?.data?.map((d) => ({
              ...d,
              title:
                d?.activity.slice(0, 1).toUpperCase() + d?.activity.slice(1),
              description: d?.description,
              created_at: moment(d?.created_at, "DD-MM-YYYY").format("lll"),
            }))}
            actions={actions}
