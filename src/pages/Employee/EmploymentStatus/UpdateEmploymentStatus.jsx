...
export default function UpdateEmploymentStatus({ handleClosePopup, id }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.name || formData.name.trim() === "") {
      newErrors.name = "Employment Status name is required";
    }
    // Validate Color
    if (!formData.color) {
  ...
  const updateEmployeeFunction = () => {
    ...
    updateSingleEmployeeStatus(formData)
      .then((res) => {
