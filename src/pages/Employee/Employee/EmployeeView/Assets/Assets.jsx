...
import { deleteAsset, getAllAssets } from "../../../../../apis/employee/asset";
...
import AddExistingAsset from "./components/AddExistingAsset";
            ...
            <div className="flex flex-col justify-end md:flex-row gap-5 w-full">
              ...
              <div className="flex justify-between md:justify-start gap-5">
                <button
                  ...
                  className="btn btn-primary w-1/3 md:w-32 lg:w-40"
                >
