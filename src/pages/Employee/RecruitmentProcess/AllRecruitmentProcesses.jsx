...
import FilterDesignation from "../Designation/FilterDesignation";
import CustomPopup from "../../../components/CustomPopup";
import CreateAndUpdateAllRecruitmentType from "./CreateAndUpdateAllRecruitmentProcess";
...
} from "../../../apis/recruitmentProcess/recruitmentProcess";
...
export default function AllRecruitmentProcesses() {
  ...
  const deleteFunction = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        deleteRecruitmentProcess(id)
          .then((res) => {
            setIsUpdated(Math.random());
            setSelectedIds([]);
            Swal.fire({
              title: "Deleted!",
              text: "Recruitment Process has been deleted.",
              icon: "success",
            });
  ...
  const [actions, setActions] = useState([
    ...
    },
    {
      ...
      permissions: [RECRUITMENT_PROCESS_DELETE],
      disabledOn: user?.business_id
        ? [{ attributeName: "is_default", value: 1 }]
        : [],
    },
  ...
  return (
    <CheckPermission
      permissionArray={[RECRUITMENT_PROCESS_CREATE, RECRUITMENT_PROCESS_VIEW]}
    >
        ...
        <div className="relative h-full">
            ...
            Component={
              <>
                {popupOption?.type === "create" && (
                  <CreateAndUpdateAllRecruitmentType
                    handleClosePopup={() => {
                      setPopupOption({
                        open: false,
                        type: "",
          ...
          <div className="flex flex-col md:flex-row justify-between items-center relative gap-5">
            <div className="flex flex-col gap-2 w-full text-center md:text-left">
              <Headings level={1}>All Recruitment Process</Headings>
              <h3>
                Total {data?.total}{" "}
                {data?.total > 1
