...
import {
  getSingleLeaveType,
  updateSingleLeaveType,
} from "../../../../apis/settings/leaveType/leaveType";
import CustomLoading from "../../../../components/CustomLoading";

export default function UpdateLeaveType({ handleClosePopup, id }) {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    getSingleLeaveType(id)
      .then((res) => {
        setFormData({
          id: res?.id,
          is_active: res?.is_active,
          is_earning_enabled: res?.is_earning_enabled,
          name: res?.name,
          type: res?.type,
          amount: res?.amount,
        });
  ...
  const updateFunction = () => {
    ...
    updateSingleLeaveType(formData)
      .then((res) => {
      ...
      <div className="px-2 py-5">
        <div className="flex flex-col">
          ...
          <CustomMultiSelect
            ...
            singleSelect
            defaultSelectedValues={types.filter(
