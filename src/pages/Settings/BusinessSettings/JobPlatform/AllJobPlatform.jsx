...
import { JOB_PLATFORM_CREATE, JOB_PLATFORM_DELETE, JOB_PLATFORM_UPDATE, JOB_PLATFORM_VIEW } from "../../../../constant/permissions";
...
import FilterDesignation from "../../../Employee/Designation/FilterDesignation";
import { deleteJobPlatform, getAllJobPlatforms } from "../../../../apis/jobPlatform/jobPlatform";
import CreateAndUpdateAllJobPlatform from "./CreateAndUpdateAllJobPlatform";


export default function AllJobPlatform() {
  ...
  const deleteFunction = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        deleteJobPlatform(id)
          .then((res) => {
            setIsUpdated(Math.random());
            setSelectedIds([]);
            Swal.fire({
              title: "Deleted!",
              text: "Job Platform has been deleted.",
              icon: "success",
            });
  ...
  const [actions, setActions] = useState([
    {
      ...
      permissions: [JOB_PLATFORM_UPDATE],
      disabledOn: [],
    },
    {
      name: "delete",
      ...
      permissions: [JOB_PLATFORM_DELETE],
      disabledOn: [],
    },
  ]);
  ...
  return (
    <CheckPermission permissionArray={[JOB_PLATFORM_CREATE, JOB_PLATFORM_VIEW]}>
        ...
        <div className="relative h-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center relative gap-5">
            <div className="flex flex-col gap-2 w-full text-center md:text-left">
              <Headings level={1}>All Job Platforms</Headings>
              <h3>
                Total {data?.total} {data?.total > 1 ? "Job Platforms" : "Job Platform"}{" "}
                Found
              </h3>
            </div>
