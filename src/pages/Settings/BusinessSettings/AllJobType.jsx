...
export default function AllJobType() {
      ...
      if (result.isConfirmed) {
        ...
        deleteJobType(id)
          .then((res) => {
            ...
            Swal.fire({
              title: "Deleted!",
              text: "Job type has been deleted.",
              icon: "success",
            });
  ...
  return (
    <CheckPermission permissionArray={[JOB_TYPE_CREATE, JOB_TYPE_VIEW]}>
        ...
        <div className="relative h-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center relative gap-5">
            <div className="flex flex-col gap-2 w-full text-center md:text-left">
              <Headings level={1}>All Job Types</Headings>
              <h3>
                Total {data?.total} {data?.total > 1 ? "Job Types" : "Job Type"}{" "}
                Found
              </h3>
            </div>
