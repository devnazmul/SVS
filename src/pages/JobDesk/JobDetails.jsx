  ...
  if (isLoading) {
    ...
    return (
      <div>
        ...
        <h1 className="text-2xl font-bold my-5">Job Details</h1>
        ...
        <div className="md:flex md:justify-between md:items-start gap-5">
          ...
          <div className="flex items-center justify-end gap-4 mt-5 md:mt-0 md:w-1/3">
            {checkPermissions([JOB_LISTING_UPDATE], permissions) && (
              <button
                data-tip="Edit"
        ...
        {/* DESCRIPTION  */}
        <div>
          <h3 className="text-2xl mt-10 font-bold my-5">Job Description</h3>
